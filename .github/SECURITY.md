...
This is the security notice for the [mc-publish](https://github.com/Xikaro/game-publish) repository. The notice explains how and when vulnerabilities should be reported.
